...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttConnectionData>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Login = { "Login", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMqttConnectionData, Login), METADATA_PARAMS(Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Login_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Login_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Password = { "Password", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMqttConnectionData, Password), METADATA_PARAMS(Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Password_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewProp_Password_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_DigitalTwinBase_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DigitalTwinBase_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo[] = {
		{ FMqttConnectionData::StaticStruct, Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewStructOps, TEXT("MqttConnectionData"), &Z_Registration_Info_UScriptStruct_MqttConnectionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMqttConnectionData), 1141400522U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DigitalTwinBase_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_2663034622(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_DigitalTwinBase_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_DigitalTwinBase_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo),
		nullptr, 0);
